...
func TestHandleListsReorder(t *testing.T) {
	...
	itemA, err := app.DB.CreateItem(ctx, list.ID, "Lait", nil, 1, nil, false, 0, nil, nil, nil, nil, false)
	if err != nil {
		t.Fatalf("creating item A: %v", err)
	}
	itemB, err := app.DB.CreateItem(ctx, list.ID, "Pain", nil, 1, nil, false, 0, nil, nil, nil, nil, false)
	if err != nil {
...
func TestHandleListsReorderRequiresWriteAccess(t *testing.T) {
	...
	item, err := app.DB.CreateItem(ctx, list.ID, "Lait", nil, 1, nil, false, 0, nil, nil, nil, nil, false)
	if err != nil {
...
func TestHandleListsReorderRejectsPartialSet(t *testing.T) {
	...
	if _, err := app.DB.CreateItem(ctx, list.ID, "Pain", nil, 1, nil, false, 0, nil, nil, nil, nil, false); err != nil {
		t.Fatalf("creating item B: %v", err)
	}
